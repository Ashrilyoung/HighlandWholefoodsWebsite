...
<html>
    ...
    <head>
        ...
        <title>Highland Wholefoods</title>
        <meta name="HighlandWholefoods" content="Highland Wholefoods Stock Management System">
    ...
    <li><a class="active" href="https://comp-hons.uhi.ac.uk/~16007873/HighlandWholefoods/HighlandWholefoodsHome.php?">Home</a></li>                       <!-- creates a navgation bar -->
    ...
    <li><a href="https://comp-hons.uhi.ac.uk/~16007873/HighlandWholefoods/WholefoodsLogOut.php?">Log Out</a></li>
        ...
        <div id = "row5">
            ...
            <br>
            <br>
            <button onclick="window.location='https://comp-hons.uhi.ac.uk/~16007873/HighlandWholefoods/HighlandWholefoodsLogIn.php'">Log In</button>
            <br>
            <br>
            <button onclick="window.location='https://comp-hons.uhi.ac.uk/~16007873/HighlandWholefoods/HighlandWholefoodsSignUp.php'">Sign Up</button>
        </div>
        </div>
        </div>
